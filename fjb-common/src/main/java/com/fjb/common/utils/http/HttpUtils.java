package com.fjb.common.utils.http;
...
//            conn.setRequestProperty("Charset", CHARSET);  //设置编码
    ...
    public static void main(String[] args) throws IOException {
        String SS="https://mbd.baidu.com/webpage?tab=comment&num=10&uk=RQw-rfO8tS1sNvX8RcUJHw&source=pc&type=newhome&format=json";
        System.out.println(SS);
        String str=requestGet(SS);
    }
}
