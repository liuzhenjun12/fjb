package com.fjb.common.utils.poi;
...
import com.fjb.common.annotation.Excel.ColumnType;
import com.fjb.common.annotation.Excel.Type;
import com.fjb.common.config.FjbConfig;
import com.fjb.common.core.domain.AjaxResult;
import com.fjb.common.core.text.Convert;
import com.fjb.common.exception.CustomException;
import com.fjb.common.utils.DateUtils;
import com.fjb.common.utils.DictUtils;
import com.fjb.common.utils.StringUtils;
import com.fjb.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    public void init(List<T> list, String sheetName, Type type)
    {
        ...
        this.type = type;
        this.fields=Excel_Utils.createExcelField(clazz,type);
        createWorkbook();
    }
    ...
    public AjaxResult exportExcel()
    {
        ...
        try
        {
            ...
            for (int index = 0; index <= sheetNo; index++)
            {
                ...
                {
                    Excel_Utils.fillExcelData(index, row,list,sheet,fields,styles);
                }
            }
            String filename = Excel_Utils.encodingFilename(sheetName);
