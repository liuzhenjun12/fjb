      ...
      <el-row >
        ...
        <el-col :span="12">
          <el-form-item label="证件类型:" prop="documentType">
            <el-select v-model="form.documentType" :disabled="disabled_date" placeholder="请选择证件类型" style="width: 60%" clearable   size="small">
              <el-option
        ...
        <el-col :span="12">
          <el-form-item label="证件号码:" style="margin-left: 10px" prop="holderIdcard">
            <el-input v-model="form.holderIdcard" placeholder="请输入假币持有人证件号" clearable :disabled="disabled_date" maxlength="20"  size="small" style="width: 60%"/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
